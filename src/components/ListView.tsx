...
import { Sun, UtensilsCrossed, Cookie, Flame } from 'lucide-react';
    ...
    <div className="space-y-3 pb-8">
      {menuData.map((item, index) => (
        <motion.button
          ...
          className="w-full bg-white/85 backdrop-blur-sm rounded-2xl p-4 shadow-sm text-left active:scale-[0.98] transition-transform"
        >
          {item.isHoliday ? (
            ...
            <>
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex items-center gap-1 bg-orange-50 px-2 py-0.5 rounded-full">
                  ...
                  <span className="text-xs text-orange-500 font-medium">{item.totalCal}kcal</span>
                </div>
                {item.specialNote && (
                  <span className="text-xs bg-[#FF9500] text-white px-2 py-0.5 rounded-full">
                    {item.specialNote}
                  </span>
                )}
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <span className="text-xs text-gray-400">{item.breakfastCal}kcal</span>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <span className="text-xs text-gray-400">{item.lunchCal}kcal</span>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    <span className="text-xs text-gray-400">{item.afternoonCal}kcal</span>
                  </div>
                </div>
              </div>
            </>
